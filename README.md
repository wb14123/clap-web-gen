...
You can check some websites that is generated by this project:

* [Example website](https://clap-web-gen-example.binwang.me): this is the website generated under the `example/` module in this project.
* [Rhyme checker](https://ci.binwang.me/): A rhyme checker for Chinese poems. [Source code](https://github.com/wb14123/rhyme-checker) is also available.
